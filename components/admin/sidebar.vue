<template>
  <div>
    <aside
      ...
      class="fixed top-0 f left-0 z-50 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 border-gray-200 border border-r"
      aria-label="Sidebar"
    >
      <div
        class="h-full px-3 flex gap-8 flex-col py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800"
      >
        <div class="flex justify-start items-center">
          <NuxtLink>
            <NuxtImg width="150" src="/static/logo-konsultanq.png" />
          </NuxtLink>
        </div>
